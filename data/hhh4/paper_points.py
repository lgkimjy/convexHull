...
# sc3 = plt.scatter(0.0, 0.75, color='cyan', alpha=1, s=200)
sc3 = plt.scatter(-0.3, 0.8, color='cyan', alpha=1, s=200)
# sc3 = plt.scatter(0.15, 0.7, color='cyan', alpha=1, s=200) # scene_b
...
# # feasible p CoM
sc8 = plt.scatter(y4, x4, color='magenta', label='feasible_p_CoM : ' + str(len(x4)), alpha=1, s=100)
...
# plt.plot(vertices_filtered[:, 0], vertices_filtered[:, 1], '-', color='yellow', linewidth=4)
